          ...
          <div className="flex items-center gap-3">
            ...
            {user?.login && (
              <a
                ...
                className="w-9 h-9 flex items-center justify-center rounded-md text-muted-foreground hover:text-foreground hover:bg-secondary/60 transition-colors duration-150"
